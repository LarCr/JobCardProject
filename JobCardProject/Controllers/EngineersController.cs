...
namespace JobCardProject.Controllers
{
    public class EngineersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EngId,EngineerName,EngineerEmail,EngineerPhone")] Engineer engineer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EngId,EngineerName,EngineerEmail,EngineerPhone")] Engineer engineer)
        {
            if (ModelState.IsValid)
            {
